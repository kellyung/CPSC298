/// @file <Musical_Note_Frequencies_2.cpp>
/// @brief <Computing frequency of musical notes with loops and arrays>
...
int main() {
    ...
    for (int nu = 0; nu < k_nOctaves; ++nu) {
        for (int k = 0; k < k_nHalfTones; ++k) {
            f = fr * pow(2, nu + (k/12.0));
            
            dWavelengthCentimeters = (speed_of_sound*100)/f;
